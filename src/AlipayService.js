    ...
    createOrderAndPay(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // 5. 调用支付宝SDK进行支付
                const result = yield react_native_alipay_payment_1.default.pay(orderStr);
                // 6. 处理支付结果
                const success = react_native_alipay_payment_1.default.isPaymentSuccess(result.resultStatus);
                const message = react_native_alipay_payment_1.default.getPaymentMessage(result.resultStatus);
                return {
                    success,
                    message,
